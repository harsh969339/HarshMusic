...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("SystemMusic/assets/font.ttf", 32)
        regular_font = ImageFont.truetype("SystemMusic/assets/font2.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "SystemMusic/assets/play_icons.png"
    ...
    font = ImageFont.truetype("SystemMusic/assets/font.ttf", 28)  # 
    text = "HARSH MUSIC"
